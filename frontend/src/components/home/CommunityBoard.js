...
const CommunityBoard = () => {
  ...
  const members = [
    ...
    },
    {
      ...
      contestName: 'So Now You Win!',
      reason: 'I want to participate in this contest because I get the opportunity to challenge myself creating a project with a prompt to follow with limited time to complete.',
    },
    {
      id: 3,
      name: 'Danny Chandia',
